  ...
  return (
    <DarkModeProvider>
      <SEO 
        ...
        keywords="ISTQB certification, ISTQB foundation level, software testing certification, ISTQB training, certified tester, ISTQB exam preparation, testing certification Mumbai"
