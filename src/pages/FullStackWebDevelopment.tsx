          ...
          <div className="relative z-10 w-full container mx-auto px-4 py-4">
            <div className="grid lg:grid-cols-[1.3fr_1fr] gap-8 items-center h-full">
              ...
              <div className="relative z-10 flex flex-col space-y-5 md:space-y-7">
                ...
                >
                  Master full stack web development with hands-on training in HTML, CSS, JavaScript, React, Node.js. Build real-world projects and launch your career as a Full Stack Developer.
                </motion.p>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                { icon: Star, title: "Live Projects", desc: "real industry grade projects you will learn" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
              ...
              >
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 7.5 Months. Classes are scheduled on weekdays/weekends with hands-on coding sessions, project development, and dedicated support for web development concepts.
                    </AccordionContent>
                  </AccordionItem>
