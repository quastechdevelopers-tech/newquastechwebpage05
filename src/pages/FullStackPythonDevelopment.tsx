          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                { icon: TrendingUp, title: "Database Integration", desc: "MySQL" },
              ...
              >
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Typical duration is 8.5 Months depending on the track. Sessions are planned on weekdays/weekends with additional practice and doubt-clearing support.
                    </AccordionContent>
                  </AccordionItem>
