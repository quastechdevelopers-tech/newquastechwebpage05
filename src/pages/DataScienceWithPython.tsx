              ...
              >
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The typical duration is 6 Months. Sessions are scheduled on weekdays/weekends with hands-on labs, capstone projects, and dedicated doubt-clearing sessions to ensure mastery of Python and data science concepts.
                    </AccordionContent>
                  </AccordionItem>
