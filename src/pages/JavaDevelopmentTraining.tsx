          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                { icon: TrendingUp, title: "REST & Database Skills", desc: "Design REST APIs and integrate SQL databases" },
              ...
              >
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 9 Months. Classes are scheduled on weekdays/weekends with hands-on coding practice, project work, and dedicated support for Java development concepts.
                    </AccordionContent>
                  </AccordionItem>
