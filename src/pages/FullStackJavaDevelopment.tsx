  ...
  return (
    <DarkModeProvider>
      <SEO 
        ...
        description="Master Full Stack Java Development with hands-on training in Core Java, Advanced Java, Spring Boot, Hibernate, React, and more. Get certified with 100% placement assistance at QUASTECH, Mumbai's leading IT training institute."
        keywords="full stack java development course, java full stack training, spring boot course, hibernate training, java developer course, full stack development, java certification, IT training Mumbai, placement guarantee"
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                { icon: TrendingUp, title: "Updated Tech", desc: "updated content we provide in our learnings" },
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-[1.2fr_1fr] gap-12 max-w-7xl mx-auto items-center">
              ...
              >
                <div className="relative">
                  <img
                    src="/images/Certificate/WhatsApp Image 2025-11-18 at 9.11.20 PM.jpeg"  //images\Certificate\WhatsApp Image 2025-11-18 at 9.11.20 PM.jpeg
              ...
              >
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Typical duration is 9 Months depending on the track. Sessions are planned on weekdays/weekends with additional practice and doubt-clearing support.
                    </AccordionContent>
                  </AccordionItem>
