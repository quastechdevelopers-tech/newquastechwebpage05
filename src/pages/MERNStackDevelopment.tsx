              ...
              >
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The program runs for 7.5 Months. Classes are scheduled on weekdays/weekends with hands-on coding sessions, project development, and dedicated support for MERN stack development.
                    </AccordionContent>
                  </AccordionItem>
