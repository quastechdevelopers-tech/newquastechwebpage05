                ...
                >
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 md:p-4 grid grid-cols-3 gap-2 md:gap-3 border border-white/20">
                    <div className="text-center">
                      <div className="text-base md:text-xl font-bold text-white">2.7 Months</div><div className="text-white/80 text-[10px] md:text-xs mt-1">Duration</div>
                    </div>
                    <div className="text-center">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                { icon: Star, title: "Projects testing", desc: "real time test performs on projects softwares" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <p className="text-lg text-gray-700 mb-8 leading-relaxed max-w-4xl mx-auto">
                  The belief at Quastech is in the practical application of theoretical knowledge. This is how our students participate in a dynamic learning process, and create projects based on the concepts.
                </p>
              </motion.div>
              ...
              >
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      Typical duration is 2.7 months covering Java, Selenium, frameworks, and CI/CD. Sessions are planned on weekdays/weekends with additional practice labs and doubt-clearing support.
                    </AccordionContent>
                  </AccordionItem>
