              ...
              >
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="faq-4" className="group bg-white border border-blue-100 rounded-2xl mb-4 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <AccordionContent className="px-6 pb-6 text-gray-700 leading-relaxed">
                      The Python Development Training typically runs for 8.5 months with weekday or weekend batches. Expect 6–8 hours of guided sessions plus dedicated lab time and doubt-clearing support.
                    </AccordionContent>
                  </AccordionItem>
